...
public class ElevatorMenuParentClass {
	...
	private final Random rand = new Random(); // ifall man skulle b�rja p� olika -roulette(kan vara roligt att ha kvar)
	// v�ningar
	...
	void elevatorRoulette() {
		...
		do {
			System.out.println("Elevator Roulette does its magic...");
			try {
				nextFloor =floor;
				Thread.sleep(1000);
